...
- [@font-face/src](https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face/src)
- [@font-face/font-display](https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face/font-display)
- [@font-face/unicode-range](https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face/unicode-range)
- [@font-face/size-adjust](https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face/size-adjust)
- [@font-face/ascent-override](https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face/ascent-override)
- [@font-face/descent-override](https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face/descent-override)
- [@font-face/line-gap-override](https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face/line-gap-override)
- [rel=preload](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/rel/preload)

## Articles
- [httparchive.org - Fonts](https://almanac.httparchive.org/en/2024/fonts)
...
- [web.dev - CSS size-adjust for @font-face](https://web.dev/articles/css-size-adjust)
- [web.dev - CSS font-size-adjust is now in Baseline](https://web.dev/blog/font-size-adjust)
- [debugbear.com - The Ultimate Guide to Font Performance Optimization](https://www.debugbear.com/blog/website-font-performance)
- [paulcalvano.com - Identifying Font Subsetting Opportunities with Web Font Analyzer](https://paulcalvano.com/2024-02-16-identifying-font-subsetting-opportunities/)
- [tunetheweb.com - Should you self-host Google Fonts?](https://www.tunetheweb.com/blog/should-you-self-host-google-fonts/)
- [zachleat.com - It’s Dangerous to Go Stallone. Take Glyphhanger](https://www.zachleat.com/web/glyphhanger/)
...
## Tools
### Subsetting
- [subsetting.xyz - Which type foundries support font subsetting?](https://subsetting.xyz/)
- [github.com - glyphhanger](https://github.com/zachleat/glyphhanger)
- [github.com - subfont](https://github.com/Munter/subfont)
- [paulcalvano.com - Web Font Analyzer](https://tools.paulcalvano.com/wpt-font-analysis/)
- [fontdrop.info - FontDrop](https://fontdrop.info/)
- [wakamaifondue.com - Wakamai Fondue](https://wakamaifondue.com/)
- [yellowlab.tools - Yellow Lab Tools](https://yellowlab.tools/)
- [textlab.dev - CSS Text Stats](https://textlab.dev/tools/css-text-stats)
...
- [textlab.dev - CSS size-adjust Tester](https://textlab.dev/tools/css-size-adjust-tester)
- [clagnut.com - Aspect value calculator](https://clagnut.com/sandbox/font-size-adjust-ex.html)
- [brunildo.org - Aspect value calculator](https://www.brunildo.org/test/xheight.pl)
